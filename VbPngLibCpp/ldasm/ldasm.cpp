...
{   
    ...
    OP_NONE,                       // 6E   
    OP_NONE,                       // 6F   
    OP_DATA_I8 | OP_REL32,         // 70   <-----+
    OP_DATA_I8 | OP_REL32,         // 71         |
    OP_DATA_I8 | OP_REL32,         // 72   
    OP_DATA_I8 | OP_REL32,         // 73   
    OP_DATA_I8 | OP_REL32,         // 74   
    OP_DATA_I8 | OP_REL32,         // 75		 
    OP_DATA_I8 | OP_REL32,         // 76		 F
    OP_DATA_I8 | OP_REL32,         // 77		 I
    OP_DATA_I8 | OP_REL32,         // 78	     X
    OP_DATA_I8 | OP_REL32,         // 79		 E
    OP_DATA_I8 | OP_REL32,         // 7A		 D
    OP_DATA_I8 | OP_REL32,         // 7B   
    OP_DATA_I8 | OP_REL32,         // 7C   
    OP_DATA_I8 | OP_REL32,         // 7D   
    OP_DATA_I8 | OP_REL32,         // 7E		 |
    OP_DATA_I8 | OP_REL32,         // 7F   <-----+
    ...
    OP_NONE,                       // FD   
    OP_MODRM,                      // FE   
    // OP_MODRM | OP_REL32		   // Bug ? that is't true FIXED
	OP_MODRM					   // FF
